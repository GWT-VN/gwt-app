---
tieuDe: "Rule: Research Deep-Dive trước khi viết nội dung"
hang: "A"
thuTu: 22
nhom: "Khung làm việc"
nguon: "GWT-Marketing-Kit rules · 22/09/2026"
---
...
PHASE 1 — KỊCH BẢN
  [1.1] Viết khung sườn v1 → `drafts/scripts/<TÊN>-v1.md`
        Bám: brief kịch bản (`rules/chuyen-gia-rewrite-brief.md`),
        style guide (`style-notes/chuyen-gia.md` + `van-noi-anh-nhu.md`),
        rule QC (`rules/ad-compliance-vn.md`)
  [1.2] User feedback → sửa → v2, v3, v4... (giữ mọi version, không ghi đè)
  [1.3] Mỗi version phải có ĐỦ output theo `chuyen-gia-rewrite-brief.md` §10
