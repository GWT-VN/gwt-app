    ...
    <section className="view">
      <div className="page-head">
        <div className="eyebrow">
          <Link href="/wiki/marketing/du-lieu/video-ideas" style={{ color: "inherit" }}>Video Ideas</Link> · idea #{row.idea_no ?? "—"}
        </div>
      ...
      <div className="notice" style={{ marginTop: 0 }}>
        <Icon.warn />
        <div>
          Transcript do máy nhận dạng. Theo <Link href="/wiki/marketing/luat/nguon-dan-chung">rule nguồn dẫn chứng mục 8b</Link>: mọi{" "}
