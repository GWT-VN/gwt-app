    ...
    <section className="view">
      <div className="page-head">
        <div className="eyebrow">
          <Link href="/wiki/marketing/du-lieu/phan-tich-video" style={{ color: "inherit" }}>Phân tích video</Link> · id {row.id}
        </div>
      ...
      <div className="notice" style={{ marginTop: 0 }}>
        <Icon.warn />
        <div>
          Transcript này do máy nhận dạng. Theo <Link href="/wiki/marketing/luat/nguon-dan-chung">rule nguồn dẫn chứng mục 8b</Link>:
