    ...
    <section className="view">
      <div className="page-head">
        <div className="eyebrow">
          <Link href="/marketing/kho-case" style={{ color: "inherit" }}>Kho case</Link> · {c.code} · {c.buoi}
        </div>
        ...
        <>
          <div className="page-head" style={{ margin: "28px 0 10px" }}>
            ...
            <p style={{ fontSize: ".84rem" }}>
              ...
              <Link href="/marketing/khung/luat-sua">xem đủ 46 luật</Link>.
            </p>
          </div>
      ...
      <div style={{ marginTop: 30 }}>
        <Link className="btn btn-primary" href="/marketing/kho-case" style={{ display: "inline-block", textDecoration: "none" }}>
          ← Về kho case
        </Link>
      </div>
    </section>
