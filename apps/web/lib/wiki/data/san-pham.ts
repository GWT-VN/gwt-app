...
export const SAN_PHAM: SanPham[] = [
  {
    ...
    "facts": [
      ...
      },
      {
        ...
        "giaTri": "✅ **`1111279087`** — tra Certipedia ra **General Water Technology (Shanghai) Co., Ltd.**<br>❌ `1111297087` trong `Thông tin chi tiết TUV.pdf` là **lỗi chép số** — ID đó thuộc **HP Inc. (laptop)**",
        "nguon": "S9, **S15**",
        "hang": "A",
        "hangGoc": "**A**",
        "congBo": "🔵"
